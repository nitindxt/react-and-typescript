...
type PizzaState = PizzaData & { pizzasNeeded: number }; //& acts as a combinator and makes new shape including {pizzaNeeded: number} with PizzaData
...
type PizzaAction = {
  type:
    ...
    | "UPDATE_SLICES_PER_PIE" /* You've got that union type making sure that we only allow for a certain set of actions.
